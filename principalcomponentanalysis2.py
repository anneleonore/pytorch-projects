...
##########################################################################################
# Step II. Dimensionality reduction using PCA
##########################################################################################
#We now also install PCA and LogisticRegression
from sklearn.decomposition import PCA
from sklearn.linear_model import LogisticRegression

#Create PCA object with two features
pca = PCA(n_components=2)

#Transforming standardized training and test dataset
...
#Train logistic regression model using transformed training data (X_train_pca)
